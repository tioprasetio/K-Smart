...
const SidebarDashboard = () => {
  ...
  return (
    <aside
      ...
      } fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full sm:translate-x-0`}
      aria-label="Sidebar"
    >
      <div
        className={`${
          isDarkMode ? "bg-[#303030]" : "bg-[#FFFFFF]"
        } h-full px-3 pb-4 overflow-y-auto`}
      >
            ...
            <Link
              ...
              className={`${
                isDarkMode
                  ...
                  : `text-[#353535] hover:bg-gray-700 hover:text-[#f0f0f0] ${
                      isActive("/dashboard") ? "bg-gray-700 text-[#f0f0f0]" : ""
                    }`
          ...
          <li>
            <Link
              ...
              className={`${
                isDarkMode
                  ? `text-[#f0f0f0] hover:bg-gray-700 hover:text-[#f0f0f0] ${
                      isActive("/dashboard/transaction") ? "bg-gray-700" : ""
                    }`
                  : `text-[#353535] hover:bg-gray-700 hover:text-[#f0f0f0] ${
            ...
            >
              <svg
                className={`${
                  isDarkMode
                    ? `text-gray-400 group-hover:text-white ${
                        isActive("/dashboard/transaction") ? "text-white" : ""
                      }`
                    : `text-gray-500 group-hover:text-white ${
                        isActive("/dashboard/transaction") ? "text-white" : ""
                      }`
          ...
          <li>
            <Link
              ...
              className={`${
                isDarkMode
                  ? `text-[#f0f0f0] hover:bg-gray-700 hover:text-[#f0f0f0] ${
                      isActive("/dashboard/product") ? "bg-gray-700" : ""
                    }`
                  : `text-[#353535] hover:bg-gray-700 hover:text-[#f0f0f0] ${
            ...
            >
              <svg
                className={`${
                  isDarkMode
                    ? `text-gray-400 group-hover:text-white ${
                        isActive("/dashboard/product") ? "text-white" : ""
                      }`
                    : `text-gray-500 group-hover:text-white ${
                        isActive("/dashboard/product") ? "text-white" : ""
                      }`
